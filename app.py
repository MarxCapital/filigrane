...
def reformat_pdf(pdf_bytes, watermark_text=None, max_pages=MAX_PAGES_PER_FICHE):
    ...
    fiches deja assez courtes. Retourne (pdf_bytes, rapport) ou rapport est
    une liste de dicts (une entree par fiche)."""
...
def process_pdf(pdf_bytes: bytes, new_name: str, add_footer: bool, reformat: bool = False):
    reformat_report = None
    if reformat:
        pdf_bytes, reformat_report = reformat_pdf(pdf_bytes, watermark_text=new_name)
